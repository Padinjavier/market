...
-- Volcando datos para la tabla market.detalle_salida: ~1 rows (aproximadamente)
DELETE FROM `detalle_salida`;
INSERT INTO `detalle_salida` (`iddetalle_salida`, `idsalida`, `idservicio`, `cantidad`) VALUES
	(12, 5, 8, 3);

-- Volcando estructura para tabla market.detalle_venta
...
-- Volcando datos para la tabla market.detalle_venta: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla market.opciones: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla market.permisos: ~26 rows (aproximadamente)
...
-- Volcando datos para la tabla market.venta: ~1 rows (aproximadamente)
DELETE FROM `venta`;
